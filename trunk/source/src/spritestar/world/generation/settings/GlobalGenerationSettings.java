package spritestar.world.generation.settings;
...
public class GlobalGenerationSettings {
	...
	public final static int desertMaxWidth = 300; // Chunks
	...
	// Caves settings
	public final static int cavesMaxWidth = 4; //Chunks, max is twice this really
	public final static int cavesMaxHeight = 2; //Chunks, max is twice this really
	public final static int cavesBoundaryOffset = 5; //Tiles, how much the boundary can vary by
}
