	...
	public void update(float delta) {
		if (lit) {
			...
			if (isOnScreen(position, 50f)) {
				...
				ParticleService.randomVelocityDiminishing(firePosition, 3f, 15f, Color.ORANGE, Util.getRandom().nextFloat() * 3f, 7f, MovementMode.EMBER, Util.getRandom().nextInt(800), Depth.MIDDLEGROUND, false);
				ParticleService.randomVelocityDiminishing(firePosition, 3f, 10f, Colors.LIGHT_SMOKE, 8f, 0f, MovementMode.EMBER, Util.getRandom().nextInt(3000), Depth.BACKGROUND, false);
			}
