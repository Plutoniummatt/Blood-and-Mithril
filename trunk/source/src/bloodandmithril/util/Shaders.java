...
public class Shaders {
	...
	public static ShaderProgram lightingFBO = new ShaderProgram(Gdx.files.internal("data/shader/pass.vp"), Gdx.files.internal("data/shader/defaultRenderer/lightingFBO.fp"));
