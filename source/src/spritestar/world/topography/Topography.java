package spritestar.world.topography;
...
import spritestar.persistence.world.ChunkLoader;
import spritestar.persistence.world.ChunkLoaderImpl;
import spritestar.persistence.world.ChunkSaver;
...
public class Topography {
	 ...
	 */
	public Topography(Class<? extends TerrainGenerator> generator) {
		try {
			this.chunkLoader = new ChunkLoaderImpl(generator.newInstance());
		} catch (Exception e) {
