...
public class RequestStartCrafting implements Request {
	 ...
	 * Constructor
	 */
	public RequestStartCrafting(Individual host, CraftingStation craftingStation, Item item) {
	...
	public Responses respond() {
		...
		individual.getAI().setCurrentTask(new Craft(individual, craftingStation, item));
