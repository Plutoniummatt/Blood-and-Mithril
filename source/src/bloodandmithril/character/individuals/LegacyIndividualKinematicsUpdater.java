...
/**
 * Legacy version of the {@link IndividualKinematicsUpdater}
 *
 * @author Matt
 */
@Singleton
@Copyright("Matthew Peck 2016")
public class LegacyIndividualKinematicsUpdater implements IndividualKinematicsUpdater {
	...
	private void fallDamage(final Individual individual, final IndividualKineticsProcessingData data) {
	...
	private void friction(final Individual individual, final IndividualState state) {
	 ...
	 */
	private void jumpOffLogic(final Topography topography, final IndividualKineticsProcessingData kinematicsBean, final IndividualState state, final ArtificialIntelligence ai) throws NoTileFoundException {
	 ...
	 */
	private boolean groundDetectionCriteriaMet(final Topography topography, final IndividualState state, final ArtificialIntelligence ai, final IndividualKineticsProcessingData kinematicsBean) throws NoTileFoundException {
	...
	public static boolean obstructed(final int offsetX, final Topography topography, final IndividualState state, final int height, final ArtificialIntelligence ai, final IndividualKineticsProcessingData kinematicsBean) throws NoTileFoundException {
	 ...
	 */
	public static boolean canStepUp(final int offsetX, final Topography topography, final IndividualState state, final int height, final ArtificialIntelligence ai, final IndividualKineticsProcessingData kinematicsBean) throws NoTileFoundException {
		final int blockspan = height/TILE_SIZE + (height % TILE_SIZE == 0 ? 0 : 1);
	 ...
	 */
	private static boolean isPassable(final float x, final float y, final Topography topography, final IndividualKineticsProcessingData kinematicsBean, final ArtificialIntelligence ai) throws NoTileFoundException {
	 ...
	 */
	private void jumpOff(final Topography topography, final IndividualState state, final IndividualKineticsProcessingData kinematicsBean) throws NoTileFoundException {
	 ...
	 */
	private boolean isToBeIgnored(final Vector2 location, final IndividualKineticsProcessingData kinematicsBean) {
		if (kinematicsBean.jumpOff != null) {
			try {
				return convertToWorldCoord(location, false).y == kinematicsBean.jumpOff.y || convertToWorldCoord(location, false).equals(kinematicsBean.jumpOff) || convertToWorldCoord(location.x, location.y - 1, false).equals(kinematicsBean.jumpOff);
