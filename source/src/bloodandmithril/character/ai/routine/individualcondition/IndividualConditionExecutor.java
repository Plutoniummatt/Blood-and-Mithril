...
/**
 * Executes {@link IndividualConditionRoutine}
 *
 * @author Matt
 */
@Singleton
@Copyright("Matthew Peck 2016")
public class IndividualConditionExecutor implements AITaskExecutor {

	@Override
	public void execute(final AITask aiTask, final float delta) {
		final IndividualConditionRoutine routine = (IndividualConditionRoutine) aiTask;
