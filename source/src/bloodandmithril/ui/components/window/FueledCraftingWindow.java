...
/**
 * {@link FueledCraftingStation} specific {@link CraftingStationWindow}
 *
 * @author Matt
 */
@Copyright("Matthew Peck 2014")
public class FueledCraftingWindow extends CraftingStationWindow {
	 ...
	 * Constructor
	 */
	public FueledCraftingWindow(int x, int y, String title, Individual individual, CraftingStation craftingStation) {
